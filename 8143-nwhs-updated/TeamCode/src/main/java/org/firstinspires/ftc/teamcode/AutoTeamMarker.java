...
public class AutoTeamMarker extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //Scan for mineral
        Result<BlockColorResult> resultant = FtcRobotControllerActivity.processFrame();
        BlockColorResult mineralPosition = resultant.getResult(); //holds the result
        if (mineralPosition.getLeftColor() == BlockColorResult.BlockColor.YELLOW) { //if the middle mineral is gold
            //drive straight forward
        } else if (mineralPosition.getRightColor() == BlockColorResult.BlockColor.YELLOW) { //if right mineral is gold
            //turn right
            //drive forward
        } else { //if left mineral is gold...
            //turn left
            //drive forward
        }
