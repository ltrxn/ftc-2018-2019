...
import vision.ruckus.BlockColorResult;
import vision.testing.BallColorResult;

public class BlockProcessor implements ImageProcessor<BallColorResult> {
    private static final String TAG = "Block Processor";
    ...
    public Result<BallColorResult> process(Mat rgbaFrame) {
        ...
        BlockColorResult.BlockColor[] beaconColors = BlockColorResult.BlockColor.values();
        BlockColorResult.BlockColor left = beaconColors[colorOfMaxMass[0]];
        BlockColorResult.BlockColor right = beaconColors[colorOfMaxMass[1]];
        ...
        return new Result(rgbaFrame, new BlockColorResult(left, right));
    }
}
